                ...
                <table class="table">
                    ...
                    <div class="row my-2">
                        ...
                        <div class="col-8 text-center">
                            <button class="btn btn-primary m-2" type ="submit">Update media</button><a class="btn btn-secondary m-2" href="index.php">Back to home</a>
                        </div>
                    </div>
                </table>
            </form>
